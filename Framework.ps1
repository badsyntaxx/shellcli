$global:commandMap = [ordered]@{
    ...
    "read log"                       = @("main", "Core", "readLog", "Output the last 50 lines of the log file.")
    ...
    "get browser apps"               = @("main", "Get Apps", "getBrowserApps", "Display a menu of web browsers.")
    "get diagnostic apps"            = @("main", "Get Apps", "getDiagnosticApps", "Display a menu of PC diagnostic software.")
    "get productivity apps"          = @("main", "Get Apps", "getProductivityApps", "Display a menu of productivity apps.")
    "get customization apps"         = @("main", "Get Apps", "getCostomizationApps", "Display a menu of customization apps.")
    #-- SYSTEM COMMANDS --#
    ...
    "services"                       = @("main", "Service Controller", "listServices", "Display the services.")
    "stop service"                   = @("main", "Service Controller", "stopService", "Stop a service.")
    "start service"                  = @("main", "Service Controller", "startService", "Start a service.")
    "restart service"                = @("main", "Service Controller", "restartService", "Restart a service.")
    "service status"                 = @("main", "Service Controller", "getServiceStatus", "Check the status of a service.")
    "service menu"                   = @("main", "Service Controller", "serviceMenu", "Display the service controller menu.")
    "schedule task"                  = @("main", "Schedule Task", "scheduleTask", "Schedule a task.")
    "update windows"                 = @("main", "Update Windows", "updateWindows", "Update Windows.")
    "clean temp files"               = @("main", "Repair Windows", "cleanTempFiles", "Clear temporary files.")
    "repair windows"                 = @("main", "Repair Windows", "repairWindows", "Repair Windows.")
